...
export default function StudentInputPage() {
  ...
  // Dummy state to track checkbox files (optional, just for UI)
  ...
  // Handler for file inputs (optional)
  const handleFileChange = (e) => {
    const { name, files } = e.target;
    setFileInputs((prev) => ({ ...prev, [name]: files[0] || null }));
  };
      ...
      >
        ...
        <Card>
          <CardHeader
            ...
            subheader="Isi formulir berikut dengan data siswa yang valid"
          />
          <CardContent>
            {/* Tab Buttons */}
            <Box
                ...
                {[ 
                  ...
                  <Box key={id} sx={{ mb: 2 }}>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", gap: 1, mt: 0.5 }}>
                      <input id={id} name={id} type="file" onChange={handleFileChange} />
